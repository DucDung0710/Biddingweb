...
public class AuctionRoom {
    ...
    private final int sellerUserId; // Id của người bán
    ...
    private final Set<Integer> acceptedUserIds = Collections.newSetFromMap(new ConcurrentHashMap<>());
     ...
     */
    public Set<Integer> getAcceptedUserIds() {
